 ...
 */
package edu.asknsoluciones.utilidades;
 ...
 */
public class Email {
    public static void sendModificacion(String para, String Nombres, String correoUsu, String clave) {
...
//2nd paso)compose message
        try {
            ...
            message.setSubject("recordatorio de claves askn soluciones ");
            java.util.Date fecha = new Date();

            message.setContent(
                    "<center><img src='http://fs5.directupload.net/images/160530/khs5cmdc.jpg' title='askn soluciones '></center>"
...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("clave sistema askn soluciones ");

            message.setContent(
                    "<center><img src='http://fs5.directupload.net/images/160530/khs5cmdc.jpg' title='recuperar contraseña'></center>"
